...
Usage:
    python -m scripts.benchmarks.runner                     # full suite, dry-run
    python -m scripts.benchmarks.runner --suite biomni_eval1 --limit 10
    python -m scripts.benchmarks.runner --mode yohas_full --live
    python -m scripts.benchmarks.runner --output results/bench_report.md
"""
...
from scripts.benchmarks.adapters import ADAPTERS, get_adapter
from scripts.benchmarks.evaluator import BenchmarkEvaluator
from scripts.benchmarks.models import (
    BenchmarkSuite,
    InstanceResult,
    RunMode,
    SuiteResults,
)
from scripts.benchmarks.report import aggregate_results, generate_report
from scripts.benchmarks.trajectory_store import TrajectoryStore
